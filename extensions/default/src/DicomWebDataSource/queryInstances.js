import QueryInstances from './qidoHelper/queryInstances.js';

const moduleName = 'QueryInstances';
...
export function queryInstances(
  ...
  console.log('MyLog, QueryInstances - queryInstances  - Send Request', filters);
  if (!dicomWebClient) {
 ...
 *
 */
export function deleteQueryInstancesPromise(StudyInstanceUID) {
  if (StudyMetaDataPromises.has(StudyInstanceUID)) {
